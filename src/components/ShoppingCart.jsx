...
export function ShoppingCart() {
    return (
        <div class="cart">
            ...
            <CartItem ID="1" qty="2" title="Sephora Skin Care - 1 u" price="91.00"/>
            <CartItem ID="2" qty="1" title="Dior Face Beauty - 1 u" price="50.00"/>
            <hr></hr>
            ...
            <div class="checkoutBtn">
                <ShopButton text="CHECKOUT" cart={false}/>
            </div>
        </div>
    )
}